...
ALTER TABLE "saved_configurations" DROP CONSTRAINT IF EXISTS "check_valid_map_type";--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "saved_configurations" DROP CONSTRAINT IF EXISTS "saved_configurations_user_id_profiles_id_fk";--> statement-breakpoint
